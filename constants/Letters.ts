...
export const LetterSvgs: Record<Letter, number | string> = {
    ...
    // [Letter.GANGE]: require('@/assets/chars/paths/ဂ.svg'),
    // [Letter.GHAGYI]: require('@/assets/chars/paths/ဃ.svg'),
    // [Letter.NGA]: require('@/assets/chars/paths/င.svg'),
    // [Letter.SALONE]: require('@/assets/chars/paths/စ.svg'),
}

export const LetterPathSvgs: Record<Letter, number | string> = {
